...
SOURCE_DIST_FOLDER = r"bin\Debug\net8.0-windows"  # 相对于 SOURCE_BASE_DIR 的路径

# 安装目标目录（程序将被直接复制到此目录）
INSTALL_BASE_DIR = r"D:\Tools\PasswordManager"

# 可执行文件名
EXE_NAME = "PasswordManager.exe"

# 快捷方式名称（不含 .lnk 后缀）
SHORTCUT_NAME = "PasswordManager"
